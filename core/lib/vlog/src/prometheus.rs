...
impl PrometheusExporterConfig {
    ...
    pub async fn run(self, mut stop_receiver: watch::Receiver<bool>) -> anyhow::Result<()> {
        ...
        // The strings are the `zksync_node_api_server` metric-group struct names
        // (LeafageRpcTimeSummary / LeafageRpcTimeSummaryCount / LeafageRpcTimeHistogram);
        // keep them in sync on rename.
