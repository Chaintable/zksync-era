...
use zksync_types::{
    ...
    transaction_request::{
        CallRequest, CallResult, Eip712Meta, MultiCallErrorCode, MultiCallResp, TransactionRequest,
    },
    u256_to_h256,
    web3::{self, Bytes, SyncInfo, SyncState},
    AccountTreeId, L2BlockNumber, L2ChainId, PackedEthSignature, StorageKey, EIP_1559_TX_TYPE,
    EIP_2930_TX_TYPE, EIP_712_TX_TYPE, H160, H256, L2_BASE_TOKEN_ADDRESS, LEGACY_TX_TYPE, U256, U64,
};
